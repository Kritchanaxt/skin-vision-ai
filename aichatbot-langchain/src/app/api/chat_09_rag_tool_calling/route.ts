...
export async function POST(req: NextRequest) {
  try {
    ...
    const agentPrompt = ChatPromptTemplate.fromMessages([
      ...
      1. **search_documents** - สำหรับค้นหาข้อมูลจากเอกสารเกี่ยวกับการดูแลผิว ผลิตภัณฑ์ และคำแนะนำต่างๆ (PDF, CSV, TXT)
      2. **get_product_info** - สำหรับค้นหาข้อมูลผลิตภัณฑ์ดูแลผิว ราคา และจำนวนในสต็อกจากฐานข้อมูล
      3. **get_sales_data** - สำหรับดูประวัติการขายผลิตภัณฑ์
      ...
      **ความสามารถของคุณ:**
      ...
      - ค้นหาและแนะนำผลิตภัณฑ์ดูแลผิวที่เหมาะสม
      
      **กฎการใช้ tools:**
      
      **สำหรับคำถามเกี่ยวกับข้อมูลทั่วไป เช่น:**
      - ข้อมูลคลินิก/ร้าน (ที่อยู่, เบอร์โทร, เวลาเปิด-ปิด)
      - ข้อมูลบริษัท
      - นโยบาย การบริการ
