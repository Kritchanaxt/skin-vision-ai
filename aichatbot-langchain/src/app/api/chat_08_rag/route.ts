...
export async function POST(req: NextRequest) {
  try {
    ...
    const ragPrompt = ChatPromptTemplate.fromMessages([
      ...
      คุณมีข้อมูลจากเอกสารที่อัปโหลดไว้ในระบบ (PDF, CSV, TXT) เกี่ยวกับผลิตภัณฑ์ดูแลผิว วิธีการดูแลผิว และข้อมูลที่เกี่ยวข้อง
      
      **หลักการตอบคำถาม:**
      - ใช้ข้อมูลจากเอกสารที่ให้มาในการตอบคำถามเกี่ยวกับผลิตภัณฑ์และการดูแลผิว
      - สามารถอธิบายผลการตรวจผิวจากภาพหรือข้อความที่พิมเข้ามาได้ (เช่น สิว ริ้วรอย จุดด่างดำ ความมัน)
      - ให้คำแนะนำการดูแลผิวเฉพาะบุคคลโดยอธิบายให้เข้าใจง่ายเหมือนคุยกับผู้ใช้ทั่วไป
      - หากไม่มีข้อมูลที่เกี่ยวข้องในเอกสาร ให้บอกว่าไม่พบข้อมูล และอาจให้คำแนะนำทั่วไปได้
      - ห้ามเดาข้อมูลเกี่ยวกับผลิตภัณฑ์ ให้ใช้ข้อมูลจากเอกสารเท่านั้น
