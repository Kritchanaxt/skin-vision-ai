...
export async function POST(req: NextRequest) {
  ...
  const prompt = ChatPromptTemplate.fromMessages([
    ['system', 'คุณเป็นผู้เชี่ยวชาญด้านการดูแลผิวและวิเคราะห์ภาพใบหน้า คุณสามารถอธิบายผลการตรวจผิวจากภาพหรือข้อความที่พิมเข้ามาได้ (เช่น สิว ริ้วรอย จุดด่างดำ ความมัน) และให้คำแนะนำการดูแลผิวเฉพาะบุคคลได้ โดยต้องอธิบายให้เข้าใจง่ายเหมือนคุยกับผู้ใช้ทั่วไป'],
    ['user', '{question}']
  ])
