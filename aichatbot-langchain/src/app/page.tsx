        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-24 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group rounded-2xl bg-white/60 backdrop-blur-sm border border-slate-200 p-8 shadow-sm hover:shadow-md transition-all duration-200 dark:bg-slate-800/60 dark:border-slate-700">
              ...
              <p className="text-slate-600 dark:text-slate-300">
                วิเคราะห์ผิวใบหน้า & คำแนะนำการดูแล วิเคราะห์สภาพผิว, ปัญหาสิว,
                รูขุมขน และให้คำแนะนำการดูแลเฉพาะบุคคล ,
                และข้อมูลสำคัญจากฐานข้อมูล Supabase
                <br />
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-slate-900 dark:text-white">
                SkinVision AI Chatbot
              </span>
            </div>
            <p className="text-slate-600 dark:text-slate-300">
              © 2025 SkinVision AI Chatbot.
            </p>
          </div>
        </div>
      </footer>
